...
public class PlayerAnimator : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        jumpPSettings.startColor = new ParticleSystem.MinMaxGradient(ColorManager.instance.playerColor);
        ParticleSystem.MainModule landPSettings = _landParticle.main;
        landPSettings.startColor = new ParticleSystem.MinMaxGradient(ColorManager.instance.platformColor);
    }
